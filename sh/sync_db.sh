...
mysqldump -u $REMOTE_USER -p$REMOTE_PASSWORD --host $REMOTE_HOST -P $REMOTE_PORT --single-transaction --column-statistics=0 --set-gtid-purged=OFF $REMOTE_DATABASE > db_backup/backup.sql
